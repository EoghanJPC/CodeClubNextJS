    ...
    return(
        <header className="container mx-auto my-2 rounded-xl">
            <nav className="py-3 sm:float-right md:bg-transparent md:opacity-100 md:z-0 md:w-1/2 lg:w-1/3 xl:w-1/4 opacity-0 sm:z-5 sm:my-0 sm:static absolute">
                ...
                <Link href="/ticketmaster"><button className="border-solid border-2 px-3 rounded-md bg-white border-opacity-30 border-black italic hover:bg-cyan-100 hover:text-cyan-800 duration-500 ">Ticket</button> </Link>
                <Link href="/login"><button className="border-solid border-2 px-3 rounded-md bg-white border-opacity-30 border-black italic hover:bg-purple-100 hover:text-purple-800 duration-500 ">Login</button> </Link>
            </nav>
        </header>
    )
}
